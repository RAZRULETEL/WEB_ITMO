package com.mastik.points.init
...
// https://github.com/spring-projects/spring-framework/blob/5.1.x/spring-core/src/main/java/org/springframework/util/SocketUtils.java
/*
...
object SocketUtils {
    ...
    private enum class SocketType {
        ...
        fun findAvailablePort(minPort: Int, maxPort: Int): Int {
            ...
            Assert.isTrue(
                maxPort >= minPort,
                "'maxPort' must be greater than or equal to 'minPort'"
            )
            Assert.isTrue(
